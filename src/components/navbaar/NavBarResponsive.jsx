...
const NAV_MENUS = [
  { label: "Mujer", icon: <ChevronRight className="w-5 h-5 cursor-pointer" />, href: "/categoria/mujer", id: "moda-mujer" },
  { label: "Hombre", icon: <ChevronRight className="w-5 h-5 cursor-pointer" />, href: "/categoria/hombre", id: "moda-mujer" },
  { label: "Infantil", icon: <ChevronRight className="w-5 h-5 cursor-pointer" />, href: "/categoria/infantil", id: "moda-mujer" },
  { label: "Basicos", icon: <ChevronRight className="w-5 h-5 cursor-pointer" />, href: "/categoria/basicos", id: "moda-mujer" },
];
        ...
        <div className="flex items-center gap-10 h-[50px] max-lg:gap-5 max-md:gap-3">
          <div className='flex gap-5 max-md:gap-2'>
            <Badge content={cartCount > 0 ? cartCount : undefined}>
              <Badge.Content>
                <IconButton color="" id="btn-cart" className='hover:shadow-none border-none' onClick={handleCartClick}>
