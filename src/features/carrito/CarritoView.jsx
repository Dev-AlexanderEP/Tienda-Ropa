  ...
  useEffect(() => {
    const fetchDireccionGuardada = async () => {
      try {
        ...
        // sin dirección guardada, continúa con campos vacíos
      }
    };
          ...
          >
            <Timeline.Item disabled={step < 0} value={0} className="w-full">
              <Timeline.Header>
                ...
                <Timeline.Icon className="mx-auto w-[50px] h-[50px] group-data-[active=true]:bg-red-500 group-data-[completed=true]:bg-red-500">
                  <ShoppingCart className="h-7 w-7" />
                </Timeline.Icon>
              </Timeline.Header>
              <Timeline.Body className="text-center">
                <Typography className="text-xl font-Poppins max-xl:text-lg max-md:text-base" color={step >= 0 ? "blue" : "inherit"}>
                  Carrito de compras
                </Typography>
            ...
            <Timeline.Item value={1} disabled={step < 1} className="w-full">
              ...
              <Timeline.Body className="text-center">
                <Typography className="text-xl font-Poppins max-xl:text-lg max-md:text-base" color={step >= 1 ? "blue" : "inherit"}>
                  Datos personales
                </Typography>
