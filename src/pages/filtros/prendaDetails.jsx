...
const PrendaDetails = () => {
  ...
  useEffect(() => {
    const fetchPrenda = async () => {
      try {
        const response = await fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prenda/${id}`);
        const data = await response.json();
        setPrenda(data.object);
                setImagen(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${data.object.imagen.principal}`); // Imagen inicial
...
const handleAddToCart = async () => {
  ...
  try {
    ...
    const abiertoRes = await axios.get(
      `https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/carrito/abierto/usuario/${usuarioId}`
    );
  ...
  tituloCarrito= "Producto agregado al carrito existente";
      ...
      const carritoRes = await axios.post(
        "https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/carrito",
...
localStorage.setItem('carritoId', carritoId);
    ...
    await axios.post(
      "https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/carrito-item/agregar",
      null,
      {
        params: {
          carritoId,
    ...
    await axios.post(
      "https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/carrito-item",
      {
        carritoId,
        prendaId: Number(id),
        talla: tallaNombre,
  ...
  // ACTUALIZA EL CONTADOR DEL CARRITO AQUÍ
    const cantidadRes = await axios.get(
      `https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/carrito/${carritoId}/cantidad-items`
    );
...
const handleRestarUno = async (id, selectedTalla) => {
  try {
    const res = await fetch(
      `https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/restar-uno?prendaId=${id}&tallaId=${selectedTalla}`,
      { method: "PUT" }
    );
                ...
                <div className='flex w-full h-full  gap-4 max-lg:flex-col'>
                    <div className='w-[107px]    flex flex-col gap-2 max-lg:flex-row max-lg:w-full'>
                        ...
                        <div
                            ...
                            onClick={() =>
                                setImagen(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.principal}`)
                            }
                            >
                            <img
                                src={`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.principal}`}
                        ...
                        onClick={() =>
                            setImagen(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.video}`)
                            }>
                        ...
                        <div
                            className="  cursor-pointer w-full h-auto"
                            onClick={() =>
                                setImagen(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.hover}`)
                            }
                        >
                            <img
                                src={`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.hover}`}
                                className=' object-contain w-full h-auto'
                        ...
                        <div
                            className="  cursor-pointer w-full h-auto"
                            onClick={() =>
                            setImagen(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.img1}`)
                            }
                        >
                            <img
                            src={`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.img1}`}
                                        className=' object-contain w-full h-auto'
                        ...
                        <div
                            className="  cursor-pointer w-full h-auto"
                            onClick={() =>
                            setImagen(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.img2}`)
                            }
                        >
                            <img
                            src={`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/${prenda.imagen.img2}`}
                                        className=' object-contain w-full h-auto'
                            alt={`${prenda.nombre} secundaria`}
                            />
                        </div>
