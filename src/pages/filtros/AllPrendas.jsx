...
React.useEffect(() => {
  const fetchProductos = async () => {
    try {
      ...
      if (noFiltros) {
        const res = await fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prendas/descuentos-aplicados-por-genero/${genero}`);
      ...
      const res = await fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/todas-prendas-filtradas?${params.toString()}`);
      console.log(res.url);
      const data = await res.json();
...
React.useEffect(() => {
    ...
    if (genero) {
      ...
      fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prendas/tallas-por-genero/${genero}`)
        .then((res) => res.json())
        .then((data) => {
      ...
      fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prendas/marcas-por-genero/${genero}`)
        .then((res) => res.json())
        .then((data) => {
        ...
        fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prendas/categorias-por-genero/${genero}`)
      .then(res => res.json())
      .then(data => {
      ...
      .catch(() => setCategorias([]));
                ...
                fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prendas/estadisticas-precios-por-genero/${genero}`)
          .then((res) => res.json())
          .then((data) => {
          ...
          fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prendas/descuentos-aplicados-por-genero/${genero}`)
      .then((res) => res.json())
      .then((data) => {
        if (data.object) setProductos(data.object);
        console.log(data);
  ...
  React.useEffect(() => {
    if (genero) {
      fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prendas/descuentos-por-genero/${genero}`)
        .then((res) => res.json())
        .then((data) => {
...
React.useEffect(() => {
  ...
  const timeout = setTimeout(() => {
    ...
    fetch(`https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/api/v1/prendas/buscar-por-nombre-genero?${params.toString()}`, {
  ...
  const url = "https://sv-02udg1brnilz4phvect8.cloud.elastika.pe/api-tienda/";
    return (
        ...
        <div className=" w-full px-[100px]  flex justify-center max-lg:px-[20px]">
            ...
            <div className="w-[250px] max-lg:hidden">
                <List >
                    ...
                    <List.Item id="categorias" onClick={() => setIsOpenCategorias((cur) => !cur)}>
                    ...
                    {/* TALLAS */}
                    <div className="border-b border-gray-300 p-1">
                    <List.Item id="tallas" onClick={() => setIsOpenTallas((cur) => !cur)}>
                        <div className="flex justify-between w-full">
                    ...
                    {/* MARCAS */}
                    <div className="border-b border-gray-300 p-1">
                    <List.Item id="marcas" onClick={() => setIsOpenMarcas((cur) => !cur)}>
                        <div className="flex justify-between w-full">
                    ...
                    {/* PRECIO */}
                    <div className="border-b border-gray-300 p-1">
                    <List.Item id="precios" onClick={() => setIsOpenPrecios((cur) => !cur)}>
                        <div className="flex justify-between w-full">
